  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <footer className="relative z-10 mt-24 backdrop-blur-2xl bg-gradient-to-b from-purple-900/90 to-purple-950/95 border-t border-fuchsia-700/40 shadow-2xl shadow-purple-500/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
              ...
              <div className="md:col-span-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold bg-gradient-to-r from-amber-400 to-fuchsia-400 bg-clip-text text-transparent">Genie Match</h3>
                    <p className="text-xs text-purple-300">AI Casting Solution</p>
                  </div>
                </div>
                <p className="text-sm text-purple-300/90 leading-relaxed mb-4">
              ...
              <div>
                <h4 className="text-white font-bold mb-4 text-sm flex items-center gap-2">
                  <span className="w-1 h-4 bg-gradient-to-b from-fuchsia-400 to-purple-600 rounded-full" />
                  서비스
                </h4>
                <ul className="space-y-2.5">
                  <li>
                    <a href="#" className="text-sm text-purple-300 hover:text-white transition-colors flex items-center gap-2 group">
                      <span className="w-1.5 h-1.5 bg-fuchsia-400/60 rounded-full group-hover:bg-fuchsia-400 group-hover:scale-150 transition-all" />
                      배우 매칭
                    </a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-2.5 mb-5">
                  <li>
                    <a href="mailto:disco922@naver.com" className="text-sm text-purple-300 hover:text-white transition-colors flex items-center gap-2 group">
                      <svg className="w-4 h-4 text-fuchsia-400 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <span className="truncate">disco922@naver.com</span>
                    </a>
                  </li>
                  <li>
                    <a href="#" className="text-sm text-purple-300 hover:text-white transition-colors flex items-center gap-2 group">
                ...
                {/* Social Links */}
                <div>
                  <h5 className="text-white/80 font-semibold mb-3 text-xs">소셜 미디어</h5>
                  <div className="flex items-center gap-2.5">
                    <a href="#" className="w-8 h-8 rounded-lg bg-purple-800/30 hover:bg-gradient-to-br hover:from-fuchsia-500/20 hover:to-purple-600/20 border border-fuchsia-600/20 hover:border-fuchsia-400/40 flex items-center justify-center text-purple-300 hover:text-white transition-all hover:scale-110 group">
            ...
            {/* Bottom Bar */}
            <div className="pt-6 border-t border-fuchsia-700/20">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
                <p className="text-sm text-purple-400/80">
                  © 2025 <span className="font-semibold text-purple-300">Genie Match AI</span>. All rights reserved.
                </p>
                <div className="flex items-center gap-6 text-xs">
                  <a href="#" className="text-purple-400/70 hover:text-white transition-colors hover:underline">개인정보처리방침</a>
                  <span className="text-purple-600">•</span>
                  <a href="#" className="text-purple-400/70 hover:text-white transition-colors hover:underline">이용약관</a>
                  <span className="text-purple-600">•</span>
                  <a href="#" className="text-purple-400/70 hover:text-white transition-colors hover:underline">쿠키 정책</a>
                </div>
              </div>
            </div>
          </div>
